...
fig1_ARM24 = plot3(gca, drone1_atti(1,[2 4]), drone1_atti(2,[2 4]), drone1_atti(3,[2 4]), ...
        '-bo', 'MarkerSize', 5);
fig1_payload = plot3(gca, drone1_atti(1,[5 6]), drone1_atti(2,[5 6]), drone1_atti(3,[5 6])+0.1, ...
        '-k', 'Linewidth', 3);
fig1_shadow = plot3(gca,0,0,-8,'xk','Linewidth',3);
...
for i = 1:simulationTime/0.01
    ...
    x(1,i) = drone1_state(1);
    y(1,i) = drone1_state(2);
    z(1,i) = drone1_state(3);
